...
_dir="$(dirname "$0")"
plugins="meta-box-group-1.1.6.zip meta-box-include-exclude-1.0.5.zip meta-box-conditional-logic-1.3.4.zip wpfront-user-role-editor-personal-pro-2.13.zip"
