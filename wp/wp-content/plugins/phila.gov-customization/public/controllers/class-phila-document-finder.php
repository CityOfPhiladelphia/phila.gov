  ...
  */
  public function get_items( $request ) {
    ...
    foreach ( $document_tables as $document_table ) {
      ...
      $unique_table['labelSort'] = isset($document_table['phila_doc_label_sort']) ? $document_table['phila_doc_label_sort'] : '';
      $unique_table['reverseCategoryOrder'] = $document_table['phila_reverse_category_order'];
      $unique_table['hideDateColumn'] = $document_table['phila_hide_date_column'];
