...
class Phila_Global_Controller {

  // Initialize the namespace and resource name.
  public function __construct() {
    $this->namespace     = 'global/v1';
    $this->resource_name = 'item';
  }
...
function phila_register_global_rest_routes() {
  $controller = new Phila_Global_Controller();
  $controller->register_routes();
}

add_action( 'rest_api_init', 'phila_register_global_rest_routes' );
