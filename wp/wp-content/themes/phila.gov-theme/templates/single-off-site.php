...
<div class="row columns mvm equal-height">
  <div class="small-24 medium-12 column intro equal pal external-site-link-left">
  ...
  <div class="small-24 medium-12 column intro equal pal external-site-link-right">
    ...
    <?php phila_util_echo_website_url();?> <i class="fa fa-sign-out bg-sidewalk"></i></a>
  </div>
</div>
