...
<div class="social-media">
  <a href="http://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()) ?>" id="fb-share" data-analytics="social"><i class="fab fa-facebook fa-lg" aria-hidden="true" target="_blank"></i></a>
  <a href="https://twitter.com/intent/tweet?text=<?php echo ( $tweet_intent != '' ) ? phila_encode_title(rwmb_meta('phila_social_intent') ) :  phila_encode_title( $the_title );?>&url=<?php echo get_permalink()?>" target="_blank"><i class="fab fa-twitter fa-lg" aria-hidden="true"></i></a>
