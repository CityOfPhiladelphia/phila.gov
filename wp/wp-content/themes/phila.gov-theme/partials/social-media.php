...
<div class="social-media">
  ...
  <a href="https://twitter.com/intent/tweet?text=<?php echo ( $tweet_intent != '' ) ? phila_encode_title(rwmb_meta('phila_social_intent') ) :  phila_encode_title( $the_title );?>&url=<?php echo get_permalink()?>" target="_blank"><i class="fa-brands fa-x-twitter fa-lg" aria-hidden="true"></i><span class="accessible">Share on Twitter</span></a>
