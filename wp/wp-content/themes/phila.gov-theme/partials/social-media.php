...
<div class="social-media">
  <a href="http://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()) ?>" id="fb-share" data-analytics="social" target="_blank"><i class="fab fa-facebook fa-lg" aria-hidden="true"></i></a>
