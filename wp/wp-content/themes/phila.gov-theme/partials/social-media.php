...
<div class="social-media mbl">
  ...
  <a href="mailto:?subject=<?php echo str_replace('+', '%20', $email_title) ?>&body=<?php echo get_permalink()?>" data-analytics="social"><i class="fa-solid fa-envelope fa-lg" aria-hidden="true"></i><span class="accessible">Send via email</span></a>
  <a href="javascript:window.print()" data-analytics="social"><i class="fa-solid fa-print fa-lg" aria-hidden="true"></i><span class="accessible">Print this page</span></a>
</div>