...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  <a href="<?php echo the_permalink(); ?>" class="card card--list card--<?php echo isset( $is_press_release ) ? 'press-release' : ''; ?> grid-x">
    <div class="content-block cell medium-24 grid-x">
      <div class="cell align-self-top">
        ...
        <header>
          <h1 class="h4"><?php echo get_the_title(); ?></h1>
        </header>
        <?php if( !isset( $is_press_release ) ): ?>
          <p><?php echo $desc ?></p>
        <?php endif;?>
