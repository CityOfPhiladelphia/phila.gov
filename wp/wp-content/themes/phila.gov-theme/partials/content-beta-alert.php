  ...
  <div class="row">
    <div class="small-24 columns">
      <p class="hide-for-small-only">
        <?php printf( 'We\'re piloting a new, user-friendly website design. To view the existing City website, visit <a class="go-back external" aria-label="back to phila.gov" href="http://www.phila.gov?opt-out">phila.gov</a>.'); ?>
      </p>
