...
<?php if(count($unique_langs) > 1) : ?>
  <div class="translated-headings">
    ...
    <?php foreach ($unique_langs as $lang): ?>
        ...
        <?php endif; ?>
        <?php if ($lang === 'spanish') : 
            $url = '/the-latest/archives/#/?template=posts&language=spanish';
            if (!empty($term)) {
              $url .= '&tag=' . $term->name;
            }else if ($slang_name) {
              $url .= '&department=' . $slang_name;
        ...
        <?php endif; ?>
        <?php if ($lang === 'chinese') : 
            $url = '/the-latest/archives/#/?template=posts&language=chinese';
            if (!empty($term)) {
              $url .= '&tag=' . $term->name;
            }else if ($slang_name) {
              $url .= '&department=' . $slang_name;
        ...
        <?php if ($lang === 'vietnamese') : 
          $url = '/the-latest/archives/#/?template=posts&language=vietnamese';
          if (!empty($term)) {
            $url .= '&tag=' . $term->name;
          }else if ($slang_name) {
            $url .= '&department=' . $slang_name;
        ...
        <?php endif; ?>
        <?php if ($lang === 'russian') : 
          $url = '/the-latest/archives/#/?template=posts&language=russian';
          if (!empty($term)) {
            $url .= '&tag=' . $term->name;
          }else if ($slang_name) {
            $url .= '&department=' . $slang_name;
        ...
        <?php endif; ?>
        <?php if ($lang === 'french') :  
          $url = '/the-latest/archives/#/?template=posts&language=french';
          if (!empty($term)) {
            $url .= '&tag=' . $term->name;
          }else if ($slang_name) {
            $url .= '&department=' . $slang_name;
