...
<article id="post-<?php the_ID(); ?>" <?php post_class( $article_classes ); ?>>
  <a href="<?php echo ($label_arr['label'] !== 'announcement') ? the_permalink() : '#' ?>" class="card card--<?php echo $label_arr['label'] ?> <?php echo isset($is_last) ? 'card--last' : ''; ?> pam" <?php echo ($label_arr['label'] == 'announcement') ? 'data-open="announcement-' . get_the_ID() .'"' : ''?>>
