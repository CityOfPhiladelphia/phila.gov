...
foreach ($page_rows as $page_row) {
  ...
  } elseif ($page_row['phila_adv_posts_options']['phila_adv_posts_select_options'] == 'phila_series') {
    $series = $page_row['phila_adv_posts_options']['phila_adv_series'];
    include(locate_template('partials/phila-series-block.php')); 
  }
} ?>