...
<section>
  <div class="mbxxl phm-mu">
    <h3 id="<?php echo sanitize_title_with_dashes($requirements_prereq_title['accordion_row_title']) ?>" class="black bg-ghost-gray phm-mu mtl mbm"><?php echo $requirements_prereq_title['accordion_row_title'] ?></h3>
    <?php
