...
<div class="cost">
  <section>
    ...
    <?php if ( !empty($is_modal) && !empty( $modal_link_text ) ) : ?>
      ...
      <div class="phm-mu"><button class="link" data-open="<?php echo sanitize_title_with_dashes($modal_link_text)?>"><i class="fas fa-info-circle"></i> <?php echo $modal_link_text ?>cool</button></div>
    <?php endif ?>
  </section>
</div>
<?php endif ?>
