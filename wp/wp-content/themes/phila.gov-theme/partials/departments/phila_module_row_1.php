...
<section class="department-module-row-one mvl">
  ...
  <?php if ( $row_one_col_one_type  == 'phila_module_row_1_col_1_custom_text' ): ?>
    ...
    <div class="large-16 columns">
      <?php if( $user_selected_template == 'project_homepage' ) : ?>
        <h2 id="about-project" class="contrast">About</h2>
      <?php else : ?>
  ...
  <?php if ( $row_one_col_two_type  == 'phila_module_row_1_col_2_connect_panel' ): ?>
    <?php if ($user_selected_template == 'homepage_v2' || $user_selected_template == 'project_homepage') : ?>
