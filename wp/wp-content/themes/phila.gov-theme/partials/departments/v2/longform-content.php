...
$vuejs_js_ids = [$longform_file_path.'/js/chunk-vendors.js', $longform_file_path.'/js/app.js?newcache'];
$vuejs_css_ids = [$longform_file_path.'/css/chunk-vendors.css', $longform_file_path.'/css/app.css?newcache'];
