...
get_header(); ?>
    ...
    <div class="small-24 large-7 columns links">
      ...
      <a class="button icon full" href="http://alpha.phila.gov/departments/mayor" target="_blank">Mayor's Office<i class="fa fa-university"></i><span class="accessible"> Opens in new window</span></a>
