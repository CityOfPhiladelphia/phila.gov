...
var _philaSearch = require('./components/phila-search.vue');

var _philaSearch2 = _interopRequireDefault(_philaSearch);
...
exports.default = {
  ...
  filters: {
    'formatDate': function formatDate(value) {
      if (value) {
        return (0, _moment2.default)(String(value)).format('MMM. DD, YYYY');
      }
    }
  },
  ...
  methods: {
    getPosts: function getPosts() {
      ...
      _axios2.default.get(endpoint + 'archives').then(function (response) {
        console.log(_this.$route.query);

        if ((0, _keys2.default)(_this.$route.query).length != 0) {

          _this.parseQueryStrings();
        } else {
    ...
    getDropdownCategories: function getDropdownCategories() {
      var _this2 = this;

      _axios2.default.get(endpoint + 'categories').then(function (response) {
    ...
    parseQueryStrings: function parseQueryStrings() {
      var _this3 = this;
      ...
      _axios2.default.get(endpoint + 'archives', {
        params: {
          'template': template,
          'category': chosenCat,
          'count': -1
    ...
    onSubmit: function onSubmit(event) {
      ...
      _axios2.default.get(endpoint + 'archives', {
        ...
        if (_this4.posts.length > 0) {
          posts.title = "No titles match.";
        }
        console.log(response.data);
      }).catch(function (e) {});
    },
    filterByCategory: function filterByCategory(selectedVal) {
      var _this5 = this;
  ...
  computed: {
    filteredPosts: function filteredPosts() {
      ...
      if (!this.checkedTemplates.length) {
        ...
        return this.posts.filter(function (j) {
          return _this6.checkedTemplates.includes(j.template);
        });
      }
    }
  }
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"archive-results"}},[_c('form',{on:{"submit":function($event){$event.preventDefault();_vm.onSubmit($event)}}},[_c('div',{staticClass:"search"},[_c('input',{ref:"search-field",staticClass:"search-field",attrs:{"id":"post-search","type":"text","name":"search","placeholder":"Search by title or keyword"}}),_vm._v(" "),_c('input',{staticClass:"search-submit",attrs:{"type":"submit","value":"submit"}})])]),_vm._v(" "),_c('div',{staticClass:"accordion",attrs:{"data-accordion":"","data-allow-all-closed":"true"}},[_c('div',{staticClass:"accordion-item is-active",attrs:{"id":"filter-results","data-accordion-item":""}},[_c('a',{staticClass:"h5 accordion-title"},[_vm._v("Filter results")]),_vm._v(" "),_c('div',{staticClass:"accordion-content",attrs:{"data-tab-content":""}},[_c('fieldset',[_c('div',{staticClass:"grid-x grid-margin-x mbl"},_vm._l((_vm.templates),function(value,key){return _c('div',{staticClass:"cell auto"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.checkedTemplates),expression:"checkedTemplates"}],attrs:{"type":"checkbox","name":key,"id":key},domProps:{"value":key,"checked":Array.isArray(_vm.checkedTemplates)?_vm._i(_vm.checkedTemplates,key)>-1:(_vm.checkedTemplates)},on:{"change":function($event){var $$a=_vm.checkedTemplates,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=key,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.checkedTemplates=$$a.concat([$$v]))}else{$$i>-1&&(_vm.checkedTemplates=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.checkedTemplates=$$c}}}}),_vm._v(" "),_c('label',{staticClass:"post-label",class:'post-label--' + key,attrs:{"for":key}},[_vm._v(_vm._s(value))])])}))]),_vm._v(" "),_c('div',{staticClass:"grid-x grid-margin-x"},[_c('div',{staticClass:"cell medium-9 auto filter-by-owner"},[_c('v-select',{attrs:{"label":"slang_name","value":_vm.selected,"options":_vm.categories,"on-change":_vm.filterByCategory},on:{"update:value":function($event){_vm.selected=$event}}})],1),_vm._v(" "),_c('div',{staticClass:"cell medium-6"},[_c('a',{staticClass:"button content-type-featured full",on:{"click":_vm.reset}},[_vm._v("Clear filters")])])])])])]),_vm._v(" "),_c('table',{staticClass:"stack theme-light archive-results",attrs:{"data-sticky-container":""}},[_vm._m(0),_vm._v(" "),_c('tbody',_vm._l((_vm.filteredPosts),function(post){return _c('tr',{key:post.id,staticClass:"clickable-row",on:{"click":function($event){$event.stopPropagation();$event.preventDefault();_vm.goToPost(post.link)}}},[_c('td',{staticClass:"title"},[_c('a',{attrs:{"href":post.link},on:{"click":function($event){$event.preventDefault();_vm.goToPost(post.link)}}},[_c('span',{staticClass:"prm"},[(post.template.includes('post'))?_c('span',[_c('i',{staticClass:"fa fa-pencil pride-purple"})]):(post.template == 'press_release')?_c('span',[_c('i',{staticClass:"fa fa-file-text-o love-park-red"})]):_c('span',[_c('i',{staticClass:"fa fa-newspaper-o ben-franklin-blue"})])]),_vm._v("\n          "+_vm._s(post.title)+"\n          ")])]),_vm._v(" "),_c('td',{staticClass:"date"},[_vm._v(_vm._s(_vm._f("formatDate")(post.date)))]),_vm._v(" "),_c('td',{staticClass:"categories"},_vm._l((post.categories),function(category,i){return _c('span',[_c('span',[_vm._v(_vm._s(category.slang_name))]),(i < post.categories.length - 1)?_c('span',[_vm._v(", ")]):_vm._e()])}))])}))])])}
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('thead',{staticClass:"sticky center bg-white",attrs:{"data-sticky":"","data-top-anchor":"filter-results:bottom","data-btm-anchor":"page:bottom","data-options":"marginTop:4.8;"}},[_c('tr',[_c('th',{staticClass:"title"},[_vm._v("Title")]),_c('th',{staticClass:"date"},[_vm._v("Publish date")]),_c('th',[_vm._v("Department")])])])}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3cc3f033", __vue__options__)
  } else {
    hotAPI.reload("data-v-3cc3f033", __vue__options__)
  }
})()}
},{"./components/phila-search.vue":2,"axios":4,"babel-runtime/core-js/object/keys":29,"moment":65,"vue":70,"vue-hot-reload-api":67,"vue-select":69,"vueify/lib/insert-css":71}],2:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('form',{on:{"submit":function($event){$event.preventDefault();_vm.onSubmit($event)}}},[_c('div',{staticClass:"search"},[_c('input',{ref:_vm.search-_vm.field,staticClass:"search-field",attrs:{"type":"text","id":_vm.id,"name":_vm.name,"placeholder":_vm.placeholder}}),_vm._v(" "),_c('input',{staticClass:"search-submit",attrs:{"type":"submit","value":"submit"}})])])}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-49d5a754", __vue__options__)
  } else {
    hotAPI.reload("data-v-49d5a754", __vue__options__)
  }
})()}
},{"vue":70,"vue-hot-reload-api":67}],3:[function(require,module,exports){
'use strict';
...
var _Archives = require('./Archives.vue');
...
var route = [{ path: '/archives' }];

new _vue2.default({
  el: '#archive-results',
  router: router,
  render: function render(h) {
    return h(_Archives2.default);
  }
});

},{"./Archives.vue":1,"vue":70,"vue-router":68}],4:[function(require,module,exports){
...
},{"../core/createError":12,"./../core/settle":15,"./../helpers/btoa":19,"./../helpers/buildURL":20,"./../helpers/cookies":22,"./../helpers/isURLSameOrigin":24,"./../helpers/parseHeaders":26,"./../utils":28,"_process":66}],6:[function(require,module,exports){
'use strict';
...
},{"./adapters/http":5,"./adapters/xhr":5,"./helpers/normalizeHeaderName":25,"./utils":28,"_process":66}],18:[function(require,module,exports){
'use strict';
...
},{"./helpers/bind":18,"is-buffer":64}],29:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/keys"), __esModule: true };
},{"core-js/library/fn/object/keys":30}],30:[function(require,module,exports){
require('../../modules/es6.object.keys');
module.exports = require('../../modules/_core').Object.keys;

},{"../../modules/_core":35,"../../modules/es6.object.keys":63}],31:[function(require,module,exports){
...
},{"./_to-absolute-index":56,"./_to-iobject":58,"./_to-length":59}],34:[function(require,module,exports){
...
},{"./_a-function":31}],37:[function(require,module,exports){
...
},{"./_descriptors":38,"./_object-dp":49,"./_property-desc":53}],46:[function(require,module,exports){
...
},{"./_an-object":32,"./_descriptors":38,"./_ie8-dom-define":46,"./_to-primitive":61}],50:[function(require,module,exports){
...
},{"./_array-includes":33,"./_has":44,"./_shared-key":54,"./_to-iobject":58}],51:[function(require,module,exports){
...
},{"./_enum-bug-keys":40,"./_object-keys-internal":50}],52:[function(require,module,exports){
...
},{"./_core":35,"./_export":41,"./_fails":42}],53:[function(require,module,exports){
...
},{"./_global":43}],56:[function(require,module,exports){
...
},{"./_defined":37,"./_iobject":47}],59:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./_to-integer');
var min = Math.min;
module.exports = function (it) {
...
},{"./_defined":37}],61:[function(require,module,exports){
...
},{"./_is-object":48}],62:[function(require,module,exports){
var id = 0;
var px = Math.random();
module.exports = function (key) {
...
},{"./_object-keys":51,"./_object-sap":52,"./_to-object":60}],64:[function(require,module,exports){
/*!
  ...
  return function (t) {
    ...
    var r = n(1),
      ...
      var l,
          ...
          y = d ? o : o[e] || (o[e] = {}),
          m = y[s],
          x = d ? r : h ? r[e] : (r[e] || {})[s];d && (n = e);for (l in n) c = !p && x && void 0 !== x[l], c && l in y || (f = c ? x[l] : n[l], y[l] = d && "function" != typeof x[l] ? n[l] : v && c ? i(f, r) : g && x[l] == f ? function (t) {
    ...
    "use strict";
    t.exports = { props: { loading: { type: Boolean, default: !1 }, onSearch: { type: Function, default: function (t, e) {} } }, data: function () {
    ...
    "use strict";
    t.exports = { watch: { typeAheadPointer: function () {
          ...
          var t = 0;if (this.$refs.dropdownMenu) for (var e = 0; e < this.typeAheadPointer; e++) t += this.$refs.dropdownMenu.children[e].offsetHeight;return t;
    ...
    var r = n(19),
      ...
      l(n, e, y);var S,
          ...
          _,
          j = function (t) {
        if (!d && t in M) return M[t];switch (t) {case b:
            return function () {
              return new n(this, t);
            };case v:
            return function () {
          ...
          E = "Array" == e ? M.entries || L : L;if (E && (_ = f(E.call(new t())), _ !== Object.prototype && _.next && (c(_, P, !0), r || s(_, p) || a(_, p, g))), k && L && L.name !== v && (A = !0, C = function () {
        return L.call(this);
      }), r && !w || !d && !A && M[p] || a(M, p, C), u[e] = C, u[P] = g, m) if (S = { values: k ? C : j(v), keys: x ? C : j(b), entries: T }, w) for (O in S) O in M || i(M, O, S[O]);else o(o.P + o.F * (d || A), e, S);return S;
    };
  }, function (t, e, n) {
    var r = n(10),
        o = n(64),
      ...
      var t,
          ...
          r = i.length,
          o = "<",
          a = ">";for (e.style.display = "none", n(58).appendChild(e), e.src = "javascript:", t = e.contentWindow.document, t.open(), t.write(o + "script" + a + "document.F=Object" + o + "/script" + a), t.close(), l = t.F; r--;) delete l[u][i[r]];return l();
    };t.exports = Object.create || function (t, e) {
      var n;return null !== t ? (s[u] = r(t), n = new s(), s[u] = null, n[a] = t) : n = l(), void 0 === e ? n : o(n, e);
    };
  }, function (t, e, n) {
    var r = n(38),
    ...
    var r = n(3),
      ...
      var n,
          s = o(t),
          u = 0,
          l = [];for (n in s) n != a && r(s, n) && l.push(n);for (; e.length > u;) r(s, n = e[u++]) && (~i(l, n) || l.push(n));return l;
    };
  }, function (t, e, n) {
    t.exports = n(6);
  }, function (t, e, n) {
    ...
    function r(t) {
      return t && t.__esModule ? t : { default: t };
        ...
        d = r(p),
        h = n(28),
        b = r(h);e.default = { mixins: [f.default, d.default, b.default], props: { value: { default: null }, options: { type: Array, default: function () {
            return [];
          } }, disabled: { type: Boolean, default: !1 }, maxHeight: { type: String, default: "400px" }, searchable: { type: Boolean, default: !0 }, multiple: { type: Boolean, default: !1 }, placeholder: { type: String, default: "" }, transition: { type: String, default: "fade" }, clearSearchOnSelect: { type: Boolean, default: !0 }, closeOnSelect: { type: Boolean, default: !0 }, label: { type: String, default: "label" }, getOptionLabel: { type: Function, default: function (t) {
            return "object" === ("undefined" == typeof t ? "undefined" : (0, l.default)(t)) && this.label && t[this.label] ? t[this.label] : t;
          } }, onChange: { type: Function, default: function (t) {
            this.$emit("input", t);
          } }, taggable: { type: Boolean, default: !1 }, pushTags: { type: Boolean, default: !1 }, createOption: { type: Function, default: function (t) {
            return "object" === (0, l.default)(this.mutableOptions[0]) && (t = (0, s.default)({}, this.label, t)), this.$emit("option:created", t), t;
          } }, resetOnOptionsChange: { type: Boolean, default: !1 }, noDrop: { type: Boolean, default: !1 }, inputId: { type: String }, dir: { type: String, default: "auto" } }, data: function () {
        ...
        } }, computed: { dropdownClasses: function () {
          return { open: this.dropdownOpen, single: !this.multiple, searching: this.searching, searchable: this.searchable, unsearchable: !this.searchable, loading: this.mutableLoading, rtl: "rtl" === this.dir };
    ...
    var r = n(13),
      ...
      var e = r(t),
          n = o.f;if (n) for (var a, s = n(t), u = i.f, l = 0; s.length > l;) u.call(t, a = s[l++]) && e.push(a);return e;
    };
  }, function (t, e, n) {
    ...
    var r = n(11);r(r.S + r.F * !n(2), "Object", { defineProperty: n(4).f });
  }, function (t, e, n) {
    var r = n(40),
    ...
    var r = n(1),
      ...
      var r = k(I, e);r && delete I[e], A(t, e, n), r && t !== I && A(I, e, r);
    } : A,
        U = function (t) {
      var e = N[t] = S(L[E]);return e._k = t, e;
    },
      ...
      return t instanceof L;
        ...
        J = function (t, e, n) {
      return t === I && J(D, e, n), y(t), e = x(e, !0), y(n), o(N, e) ? (n.enumerable ? (o(t, V) && t[V][e] && (t[V][e] = !1), n = S(n, { enumerable: w(0, !1) })) : (o(t, V) || A(t, V, w(1, {})), t[V][e] = !0), G(t, e, n)) : A(t, e, n);
    },
        K = function (t, e) {
      y(t);for (var n, r = v(e = m(e)), o = 0, i = r.length; i > o;) J(t, n = r[o++], e[n]);return t;
    },
        Y = function (t, e) {
      return void 0 === e ? S(t) : K(S(t), e);
    },
        q = function (t) {
      var e = $.call(this, t = x(t, !0));return !(this === I && o(N, t) && !o(D, t)) && (!(e || !o(this, t) || !o(N, t) || o(this, V) && this[V][t]) || e);
    },
        Q = function (t, e) {
      if (t = m(t), e = x(e, !0), t !== I || !o(N, e) || o(D, e)) {
        var n = k(t, e);return !n || !o(N, e) || o(t, V) && t[V][e] || (n.enumerable = !0), n;
      }
    },
        Z = function (t) {
      for (var e, n = M(m(t)), r = [], i = 0; n.length > i;) o(N, e = n[i++]) || e == V || e == u || r.push(e);return r;
    },
        X = function (t) {
      for (var e, n = t === I, r = M(n ? D : m(t)), i = [], a = 0; r.length > a;) !o(N, e = r[a++]) || n && !o(I, e) || i.push(N[e]);return i;
    };R || (L = function () {
      ...
      };return i && H && G(I, t, { configurable: !0, set: e }), U(t);
    }, s(L[E], "toString", function () {
      return this._k;
    }), _.f = Q, j.f = J, n(36).f = O.f = Z, n(20).f = q, n(37).f = X, i && !n(19) && s(I, "propertyIsEnumerable", q, !0), h.f = function (t) {
      return U(d(t));
    }), a(a.G + a.W + a.F * !R, { Symbol: L });for (var tt = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), et = 0; tt.length > et;) d(tt[et++]);for (var nt = P(d.store), rt = 0; nt.length > rt;) b(nt[rt++]);a(a.S + a.F * !R, "Symbol", { for: function (t) {
        return o(B, t += "") ? B[t] : B[t] = L(t);
      }, keyFor: function (t) {
        if (!W(t)) throw TypeError(t + " is not a symbol!");for (var e in B) if (B[e] === t) return e;
      }, useSetter: function () {
        H = !0;
      }, useSimple: function () {
        H = !1;
      } }), a(a.S + a.F * !R, "Object", { create: Y, defineProperty: J, defineProperties: K, getOwnPropertyDescriptor: Q, getOwnPropertyNames: Z, getOwnPropertySymbols: X }), C && a(a.S + a.F * (!R || l(function () {
      var t = L();return "[null]" != T([t]) || "{}" != T({ a: t }) || "{}" != T(Object(t));
    })), "JSON", { stringify: function (t) {
        if (void 0 !== t && !W(t)) {
          for (var e, n, r = [t], o = 1; arguments.length > o;) r.push(arguments[o++]);return e = r[1], "function" == typeof e && (n = e), !n && g(e) || (e = function (t, e) {
    ...
    t.exports = function (t, e, n, r) {
      var o,
          i = t = t || {},
          a = typeof t.default;"object" !== a && "function" !== a || (o = t, i = t.default);var s = "function" == typeof i ? i.options : i;if (e && (s.render = e.render, s.staticRenderFns = e.staticRenderFns), n && (s._scopeId = n), r) {
    ...
    t.exports = { render: function () {
        var t = this,
            e = t.$createElement,
            n = t._self._c || e;return n("div", { staticClass: "dropdown v-select", class: t.dropdownClasses, attrs: { dir: t.dir } }, [n("div", { ref: "toggle", class: ["dropdown-toggle", "clearfix", { disabled: t.disabled }], on: { mousedown: function (e) {
              e.preventDefault(), t.toggleDropdown(e);
            } } }, [t._l(t.valueAsArray, function (e) {
          return n("span", { key: e.index, staticClass: "selected-tag" }, [t._t("selected-option", [t._v("\n        " + t._s(t.getOptionLabel(e)) + "\n      ")], null, e), t._v(" "), t.multiple ? n("button", { staticClass: "close", attrs: { type: "button", "aria-label": "Remove option" }, on: { click: function (n) {
                t.deselect(e);
              } } }, [n("span", { attrs: { "aria-hidden": "true" } }, [t._v("×")])]) : t._e()], 2);
        }), t._v(" "), n("input", { directives: [{ name: "model", rawName: "v-model", value: t.search, expression: "search" }], ref: "search", class: [{ disabled: t.disabled }, "form-control"], style: { width: t.isValueEmpty ? "100%" : "auto" }, attrs: { type: "search", placeholder: t.searchPlaceholder, readonly: !t.searchable, id: t.inputId, "aria-label": "Search for option" }, domProps: { value: t.search }, on: { keydown: [function (e) {
          ...
          return n("li", { key: r, class: { active: t.isOptionSelected(e), highlight: r === t.typeAheadPointer }, on: { mouseover: function (e) {
                t.typeAheadPointer = r;
              } } }, [n("a", { on: { mousedown: function (n) {
                n.preventDefault(), t.select(e);
              } } }, [t._t("option", [t._v("\n          " + t._s(t.getOptionLabel(e)) + "\n        ")], null, e)], 2)]);
        }), t._v(" "), t.filteredOptions.length ? t._e() : n("li", {
          staticClass: "no-options" }, [t._t("no-options", [t._v("Sorry, no matching options.")])], 2)], 2) : t._e()])], 1);
      }, staticRenderFns: [] };
  }, function (t, e, n) {
    function r(t, e) {
      for (var n = 0; n < t.length; n++) {
        var r = t[n],
            o = f[r.id];if (o) {
          o.refs++;for (var i = 0; i < o.parts.length; i++) o.parts[i](r.parts[i]);for (; i < r.parts.length; i++) o.parts.push(u(r.parts[i], e));
        } else {
          for (var a = [], i = 0; i < r.parts.length; i++) a.push(u(r.parts[i], e));f[r.id] = { id: r.id, refs: 1, parts: a };
        }
      }
    }function o(t) {
      ...
      e = e || {}, "undefined" == typeof e.singleton && (e.singleton = d()), "undefined" == typeof e.insertAt && (e.insertAt = "bottom");var n = o(t);return r(n, e), function (t) {
        for (var i = [], a = 0; a < n.length; a++) {
          ...
          var u = i[a];if (0 === u.refs) {
            for (var c = 0; c < u.parts.length; c++) u.parts[c]();delete f[u.id];
          }
        }
      };
    };var y = function () {
...
},{"_process":66}],71:[function(require,module,exports){
