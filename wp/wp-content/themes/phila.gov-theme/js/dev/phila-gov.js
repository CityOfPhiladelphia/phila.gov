  ...
  if ($("#services-list [data-services-menu]").length) {
    ...
    .done( function( data ) {
      $.each(data, function(i, value) {
        $('#services-list [data-services-menu]').prepend('<div class="medium-8 columns end"><div class="valign"><div class="valign-cell"><a href=' + value.link + ' data-equalizer-watch><span><i class="' + value.meta.phila_page_icon  + ' fa-2x phm"></i> ' + value.title.rendered + '</span></a></div></div></div>');
      })
