        ...
        <div class="top-bar bg-ghost-gray" id="responsive-menu">
          ...
          <div class="top-bar-right translations-nav">
            <ul id="translations-menu" class="dropdown menu" data-dropdown-menu>
              <li class="show-for-medium"><a href="<?php echo get_home_url(); ?>/">English</a></li>
<?php if ( (is_front_page() === True) or (get_post_type($post->ID) != 'post') ): ?>
              <li class="show-for-medium"><a href="<?php echo get_home_url(); ?>/es/">Español</a></li>
              <li class="show-for-medium"><a href="<?php echo get_home_url(); ?>/zh/">中文</a></li>
<?php endif; ?>
              <li>
                ...
                <ul class="translations-dropdown menu" data-dropdown-content>
                    <li class="show-for-small-only"><a href="<?php echo get_home_url(); ?>/">English</a></li>
 <?php if ( (is_front_page() === True) or (get_post_type($post->ID) != 'post') ): ?>
                   <li class="show-for-small-only"><a href="<?php echo get_home_url(); ?>/es/">Español</a></li>
                    <li class="show-for-small-only"><a href="<?php echo get_home_url(); ?>/zh/">中文</a></li>
 <?php endif; ?>
